...
#define WRITE_sda() DDRD |= 0b00000010 //SDA must be output when writing
#define READ_sda()  DDRD &=~0b00000010 //SDA must be input when reading - don't forget the resistor on SDA!!
